...
public class ClientTest
{
    ...
    [Test]
    public void Test_MainClientObjects()
    {
       Assert.DoesNotThrow(() => new JettonBurn()
        {
            Amount = new Coins(0), Operation = JettonOperation.BURN, QueryId = 1,
            Transaction = new TransactionsInformationResult()
        });
    }
}
